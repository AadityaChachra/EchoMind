...
def ask_mental_health_specialist(query: str) -> str:
    """
    Generate a therapeutic response using the MedGemma model. Provide only the response recieved from MedGemma Model.
...
def find_nearby_therapists_by_location(location: str) -> str:
    ...
    return (
        ...
        "- Dr. Ayesha Kapoor - (+91)9999888822\n"
        "- Dr. James Patel - (+91)9999777722\n"
        "- MindCare Counseling Center - (+91)9898888822"
    )
